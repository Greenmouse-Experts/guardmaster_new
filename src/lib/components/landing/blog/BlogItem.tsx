    ...
    <div>
      ...
      <div className="p-4 mt-2 shadow-lg bg-white">
        <div className="h-40 2xl:h-36">
          ...
          <p className="mt-2">{formatName(data?.brief, 85)}</p>
        </div>
        <div className="flex justify-end">
          <button className="flex gap-x-3 items-center !syne hover:fw-600 hover:text-primary" onClick={() => navigate(`/blog/${data.id}`)}>
