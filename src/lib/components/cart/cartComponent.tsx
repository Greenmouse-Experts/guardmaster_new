      ...
      <div>
              ...
              <div className="border-b pb-3 w-full">
                <div className="flex gap-x-2">
                  <img
                    src={item.coverImg}
                    alt="cover"
                    className="w-16 lg:w-20 aspect-square shrink-0 object-cover"
                  />
        ...
        <div className="grid gap-2 absolute bottom-5 left-0 w-full px-5">
          ...
          <Button
            ...
            altClassName="py-2 btn-feel w-full rounded-xl shadow"
            onClick={proceedToPayment}
          />
          <Button
            title={"Clear Cart"}
            altClassName="py-2 text-white w-full rounded-xl shadow bg-red-600"
            disabled={!cart.length}
            onClick={() => emptyCart()}
          />
        </div>
