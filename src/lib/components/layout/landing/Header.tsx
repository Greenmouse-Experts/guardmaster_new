...
const Header = () => {
  ...
  return (
    <>
      <div
        ref={headerRef}
        className={isSticky ? "fixed top-0 left-0 z-[50000] w-full" : ""}
      >
          ...
          <div className="box flex items-center justify-between fs-500 ">
            ...
            <ul className="flex items-center gap-x-4">
              {isLoggedIn ? (
                <>
                  ...
                  <li className="hidden sm:block border-r border-black pr-4">
                    <Link
                      to={"/user/dashboard"}
                      className="fw-600 fs-200 lg:fs-300"
                    >
                      Dashboard
                    </Link>
                  </li>
                ...
                <>
                  <li className="hidden md:block border-r border-black pr-4">
                    <Link
                      to={"/auth/login"}
                      className=" fs-200 lg:fs-300 fw-600"
                    >
                      Student Login
                    </Link>
                  </li>
              ...
              <li className="flex gap-x-1 items-center">
                ...
                <Link
                  to={"https://www.facebook.com/GuardmasterInstituteCanada/"}
                >
                  <FaSquareFacebook className="fs-500" />
                </Link>
                <Link
                  to={
                    "https://linkedin.com/company/guardmasterinstitutecanada/"
                  }
                >
                    ...
                    <Menu>
                      <MenuHandler>
                        <Button className="bg-transparent flex items-center gap-x-2 p-0 m-0 shadow-none hover:shadow-none text-white !mont lg:!syne capitalize font-[500] text-[14px] lg:text-[16px]">
                          <span className="!syne fw-700">About Us</span>{" "}
                          <IoIosArrowDown />
                        </Button>
                      </MenuHandler>
